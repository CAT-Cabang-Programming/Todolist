    ...
    <div className="bg-sky-100 h-screen pt-30">
      <div className="flex flex-col w-full ">
        ...
        <div className="flex  items-center mt-5 gap-2 mx-auto">
          <input
            ref={inputRef}
            className="bg-white text-left border-gray-100 border-2 p-4  mt-1 rounded-xl shadow-md w-[300px] max-w-full "
            type="text"
            placeholder="Add your task"
          ></input>
          <input
            onChange={(e) => setDeadline(e.target.value)}
            className="bg-white text-left border-gray-100 border-2 p-4  mt-1 rounded-xl shadow-md w-[250px] max-w-full "
            type="datetime-local"
            placeholder="Add your Deadline"
          ></input>
          <button
            onClick={addnow}
            className="bg-sky-500 rounded-xl border-none  p-4  mt-1 text-white font-bold cursor-pointer"
          >
            ADD +
          </button>
        </div>
